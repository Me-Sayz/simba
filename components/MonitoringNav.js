...
import { LayoutDashboard, Package, ScanLine, History, User } from 'lucide-react'
...
export default function MonitoringNav({ profile, lowStock = 0 }) {
      ...
      <aside className="hidden md:flex flex-col fixed top-0 left-0 h-screen w-60 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 px-4 py-6 z-30">
        <div className="flex items-center gap-2.5 px-2 pb-7">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-gray-400 truncate">Mode Monitoring</p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                {href === '/stock' && lowStock > 0 && (
                  <span className="ml-auto text-[10px] font-bold bg-amber-c/15 text-amber-c px-1.5 py-0.5 rounded-full shrink-0">
                    {lowStock}
                  </span>
                )}
              </Link>
